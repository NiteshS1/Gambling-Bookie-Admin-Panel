  ...
  return (
    <>
      <div className="flex justify-center bg-gray-300 mt-3 mx-5 rounded-sm border p-4 border-black ">
        ...
        <select name="sources" id="sources" className='mt-3 mx-5 p-1 pr-24'>
      ...
      <div>
        ...
        <div className="container mx-auto px-4 py-4 ">
          ...
          <h1 className="bg-blue-950 text-white mb-5 p-2 rounded-t-md">Profit Loss</h1>
          ...
          <table className="min-w-full bg-white border border-gray-300">
            <thead>
              <tr className="bg-gray-100">
                <th className="border border-gray-300 px-4 py-2">Sport Name</th>
                <th className="border border-gray-300 px-4 py-2">Upline Profit/Loss</th>
                <th className="border border-gray-300 px-4 py-2">Downline Profit/Loss</th>
                <th className="border border-gray-300 px-4 py-2">Commsion</th>
              </tr>
            </thead>
            <tbody>
